...
try {
  ...
  $nama = htmlspecialchars(filter_input(INPUT_POST, 'nama', FILTER_SANITIZE_FULL_SPECIAL_CHARS));
  $alamat = htmlspecialchars(filter_input(INPUT_POST, 'alamat', FILTER_SANITIZE_FULL_SPECIAL_CHARS));
